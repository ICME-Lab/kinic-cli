...
use tui_kit_runtime::{
    CoreError, CoreResult, ProviderOutput, ProviderSnapshot, SettingsEntry, SettingsSection,
    SettingsSnapshot,
};
...
fn copy_principal_id_from_settings_only_targets_principal_id() {
    ...
    let copied = copy_principal_id_from_settings(&state, crossterm::event::KeyCode::Enter);
