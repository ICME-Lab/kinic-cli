...
pub struct TuiKitUi<'a> {
    ...
    pub(super) insert_text_cursor: Option<(usize, usize)>,
    ...
    pub(super) rename_description_cursor: Option<(usize, usize)>,
...
impl<'a> TuiKitUi<'a> {
    pub fn new(theme: &'a Theme) -> Self {
        Self {
            ...
            rename_description_cursor: None,
