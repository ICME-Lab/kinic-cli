...
impl ThemeKind {
    ...
    pub fn from_name(name: &str) -> Self {
        ...
        match s {
            ...
            "pink" | "pink_neon" | "pink neon" => ThemeKind::Pink,
...
impl Theme {
    ...
    pub fn pink() -> Self {
        ...
        theme.name = "Pink".into();
        // Keep background tones identical to default_dark and tint only accents/lines/text colors.
        theme.accent = Color::Rgb(255, 105, 180);
        theme.accent_dim = Color::Rgb(214, 85, 152);
        theme.border_focused = Color::Rgb(255, 105, 180);
        theme.tab_active_bg = Color::Rgb(166, 66, 126);
        theme.keyword = Color::Rgb(255, 121, 198);
        theme.function = Color::Rgb(255, 183, 221);
        theme.type_ = Color::Rgb(235, 186, 255);
        theme.number = Color::Rgb(255, 160, 198);
        theme
    }
