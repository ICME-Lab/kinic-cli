        ...
        sections: vec![
            ...
            UiSection {
                ...
                body_lines: if user_lines.is_empty() {
                    vec!["unavailable".to_string(), String::new(), "  + Add User".to_string()]
                } else {
                    user_lines
                },
            },
...
fn memory_user_lines(lines: &[String]) -> Vec<String> {
    ...
    {
        return vec!["none".to_string(), String::new(), "> + Add User".to_string()];
    } else if lines
        .first()
...
mod tests {
    ...
    fn memory_content_overview_includes_memory_details() {
        ...
        assert!(content.sections.iter().all(|section| section.heading != "Search"));
