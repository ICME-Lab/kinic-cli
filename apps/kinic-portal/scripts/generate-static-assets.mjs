...
// What: regenerates next/og data URLs and favicon.ico from public asset sources.
...
const framePath = path.join(ogRoot, "kinic-og-frame-clean.png");
const logoPath = path.join(ogRoot, "kinic-logo-transparent.png");
...
// What: provides runtime-safe image data URLs sourced from public assets.
// Why: next/og on Cloudflare must not fetch local public files during prerender.

export const OGP_FRAME_SRC = "data:image/png;base64,${frame.toString("base64")}";
export const OGP_LOGO_SRC = "data:image/png;base64,${logo.toString("base64")}";
`;
